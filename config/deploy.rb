...
set :application_name, 'ChatsApp'
set :repository, 'git@github.com:ragnarook83/ChatsApp.git'
...
task :testing do
  ...
  set :deploy_to, '/home/testing/apps/chatsapp'
